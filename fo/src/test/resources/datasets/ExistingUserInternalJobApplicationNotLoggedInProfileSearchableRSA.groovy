...
putDataset("MyEfcLiveJobsWithUser") {
    ...
    SavedSearch(
            ...
            query: "keywords=${random}&match-mode=ALL&updated-within=ONE_YEAR&sort-order=ASC&order-by=RELEVANCE&page-size=10&format=JSON&showMarkedStatus=true&showProjects=true&showLastViewDate=true",
            mailingInterval: MailingInterval.LIVE,
            emailResults: true,
