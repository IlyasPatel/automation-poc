...
import com.efinancialcareers.myefc.qa.desktop.FlashContext;
        ...
        notifier.addListener(new RunListener() {
            ...
            public void testFinished(Description description) throws Exception {
                if (!TEST_SENTENCE.equalsIgnoreCase(description.getDisplayName())) {
                    ...
                    SessionData.INSTANCE.setFlashContext(cloner.deepClone(FlashContext.INSTANCE.getFlash()));
                    FlashContext.INSTANCE.clearFlash();
                }
            }
        });
