...
public class Keyboard {
    ...
    private static final int TYPING_DELAY_MILLISECONDS = 35;
    private Robot robot;
    ...
    /**
     * Converts each character in a string to its keyboard equivalent value.
     * @param characters character sequence
     */
    ...
    /**
     * Converts single character to its keyboard equivalent value.
    ...
    private void doType(int[] keyCodes, int offset, int length) {
        ...
        delayForEnterKeyToBeRecognised();
    }

    private void delayForEnterKeyToBeRecognised() {
        robot.delay(TYPING_DELAY_MILLISECONDS);
    }
